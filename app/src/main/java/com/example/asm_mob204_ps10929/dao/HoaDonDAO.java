...
public class HoaDonDAO {
    ...
    values.put("ngaymua",sdf.format(hd.getNgayMua())); try {
...
return 1;
    ...
    //update
    public int updateHoaDon(HoaDon hd){ ContentValues values = new ContentValues(); values.put("mahoadon",hd.getMaHoaDon());
